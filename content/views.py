...
from .models import Entry, EntryCategory, EntryTag, EntryLike
...
#         # Optional: map tags to categories for sidebar filtering
#         category_tags_map = {
...
#         status="published",
#         # category=category,
#         categories=category,  # ✅ FIXED: use 'categories' not 'category'
#         tags=tag
#     ).order_by("-created_at")

#     category_tags = EntryTag.objects.filter(project__category=category).distinct()
#     all_categories = EntryCategory.objects.all()
